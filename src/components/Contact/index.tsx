...
const Contact = () => {
  ...
  return (<>
    <section id="contact" className="relative py-20 md:py-[120px]">
      ...
      <div className="absolute left-0 top-0 -z-[1] h-1/2 w-full bg-white dark:bg-dark-700 lg:h-[45%] xl:h-1/2"></div>
          ...
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div className="ud-contact-content-wrapper">
              <div className="ud-contact-title mb-12 lg:mb-[150px]">
                ...
                <h3 className="flex items-center w-full gap-2 mb-4  text-[25px] lg:text-[30px] font-semibold leading-[1.14] text-dark dark:text-white">
                <svg
                    width="32"
                    height="32"
                    viewBox="0 0 22 22"
                ...
                <div className="flex items-center gap-3"> <svg
                    width="32"
                    height="32"
                    viewBox="0 0 22 22"
                    fill="none"
                ...
                100% dos nossos clientes satisfeitos
                </h3>
              </div>
