          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4">
              <div
                ...
                data-wow-delay=".2s"
              >
                <h1 className="mb-6 text-3xl font-bold leading-snug text-white sm:text-3x1 sm:leading-snug lg:text-4xl lg:leading-[1.2]">
                Software de Gestão Comercial para mais <b className="hover:bg-secondary">Produtividade</b> e <b className="hover:bg-secondary">Eficiência</b> no seu negócio
                </h1>
                ...
                <div>
                  ...
                  15 dias para testar o
                  sistema comercial online da PosVenda 
                  </p>
